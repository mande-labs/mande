...
type Ballot struct {
	...
	Sign  uint64 `protobuf:"varint,3,opt,name=sign,proto3" json:"sign,omitempty"`
}
...
func (*Ballot) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e15b0ec3762bf51, []int{0}
}
...
func init() {
	proto.RegisterType((*Ballot)(nil), "mandelabs.mande.vote.Ballot")
}

func init() { proto.RegisterFile("vote/ballot.proto", fileDescriptor_3e15b0ec3762bf51) }

var fileDescriptor_3e15b0ec3762bf51 = []byte{
	// 177 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Ballot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Sign != 0 {
		i = encodeVarintBallot(dAtA, i, uint64(m.Sign))
		i--
		dAtA[i] = 0x18
	}
	if m.Count != 0 {
		i = encodeVarintBallot(dAtA, i, uint64(m.Count))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Index) > 0 {
...
func (m *Ballot) Size() (n int) {
	...
	if m.Count != 0 {
		n += 1 + sovBallot(uint64(m.Count))
	}
	if m.Sign != 0 {
		n += 1 + sovBallot(uint64(m.Sign))
	}
	return n
}
