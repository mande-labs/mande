...
import MandeLabsMandeMandelabsMandeVote from './mande-labs/mande/mandelabs.mande.vote'
...
export default { 
  ...
  MandeLabsMandeMandelabsMandeVote: load(MandeLabsMandeMandelabsMandeVote, 'mandelabs.mande.vote'),
